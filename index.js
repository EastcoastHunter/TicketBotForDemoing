...
// Bot isEnabled
bot.on('ready', async () => {
  console.log(`${config.prefix}help // ${bot.user.username} is online curent status is online! in ${bot.guilds.size} servers`)
  try {
...
bot.on('ready', ()=>{
  ...
  bot.user.setActivity('Ticketmaker, Hunter\'s Web Designs')
});
// Listener
